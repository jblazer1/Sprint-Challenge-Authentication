...
Sessions are used to allow a server to store information about a client. That information can then be used for a variety of purposes. Such as authentication.

1. What does bcrypt do to help us store passwords in a secure manner.

bcrypt uses a one way process called "hashing". It translates a password into a string that can not be reverse engineered back into the original password.
